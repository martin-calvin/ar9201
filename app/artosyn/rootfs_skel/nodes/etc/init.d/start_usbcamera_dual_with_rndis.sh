...
/etc/init.d/usb_gadget_configfs.sh rndis+uvc+uvc_hdr 0 0 0x1d6b 0x0102

if [ -e "/local/usr/bin/uvc_service" ]; then
	...
	/tmp/uvc_service --mode uvc --fps 25 --ctl-int 4 --str-int 5 --pipe_index 1 --multi --res0 1920 1080 --res1 640 480 --osd --hdr &
	sleep 3
	/tmp/uvc_service --mode uvc --fps 30 --ctl-int 2 --str-int 3 --pipe_index 0 --multi --res0 1920 1080 --res1 640 480 &
fi
