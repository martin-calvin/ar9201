...
FILE_NAME="/usrdata/usr/data/arstack/start_$gAPP.sh"
KEY_STRING="usb_gadget_configfs_tof"
ADB_ENABLE_STRING="\\\t/usrdata/usr/data/arstack/usb_gadget_configfs_tof.sh orbbec+uvc_rgb+uvc_depth+uvc_ir+adbd 0 0 0x2BC5 0x062e"
ADB_DISABLE_STRING="\\\t/usrdata/usr/data/arstack/usb_gadget_configfs_tof.sh orbbec+uvc_rgb+uvc_depth+uvc_ir 0 0 0x2BC5 0x062e"
