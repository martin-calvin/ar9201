...
typedef enum
{
    ...
    ebd_integration_time = 222,//2bytes
    ebd_vt_pix_clk_div = 320,
    ebd_vt_sys_clk_div = 324,
    ebd_vt_pre_pll_clk_div = 328,
    ebd_vt_pll_multiplier = 332,
}ebd_info_t;
...
*   Input        : const uint8_t *pEbdData10bit  
*   Output       : None
*   Return Value : uint16_t integrationTime (us)
*****************************************************************************/
uint16_t tof_embedded_33d_getIntegrationTime(const uint8_t *pEbdData10bit)
{
    ...
    UnpackEmbedded10Bit((uint16_t *)pEbdData10bit, (uint8 *)&coarse_integration_time, ebd_integration_time, 2);
    UnpackEmbedded10Bit((uint16_t *)pEbdData10bit, (uint8 *)&vt_pll_multi, ebd_vt_pll_multiplier, 2);
    UnpackEmbedded10Bit((uint16_t *)pEbdData10bit, (uint8 *)&vt_pre_pll_clk_div, ebd_vt_pre_pll_clk_div, 2);
    UnpackEmbedded10Bit((uint16_t *)pEbdData10bit, (uint8 *)&vt_sys_clk_div, ebd_vt_sys_clk_div, 2);
    UnpackEmbedded10Bit((uint16_t *)pEbdData10bit, (uint8 *)&vt_pix_clk_div, ebd_vt_pix_clk_div, 2);
    UnpackEmbedded10Bit((uint16_t *)pEbdData10bit, (uint8 *)&line_length_pck, ebd_line_length_pck, 2);
