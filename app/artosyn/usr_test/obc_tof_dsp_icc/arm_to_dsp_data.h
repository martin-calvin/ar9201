...
typedef struct ob_tof_calib_param
{
	...
	ObToFTempCompensation temp_comp[2]; 		//ToF的温度补偿		ObToFTempCompensation已在tof_arm_api.h中定义
	ObToFDistanceCalib dist_calib[2];			// ToF的距离补偿	ObToFDistanceCalib已在tof_arm_api.h中定义
